# Generated by Django 2.2.3 on 2019-07-08 13:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, to='boards.Board')),
                ('children', models.ManyToManyField(blank=True, related_name='_board_children_+', to='boards.Board')),
            ],
        ),
        migrations.CreateModel(
            name='Topic',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('message', martor.models.MartorField(max_length=4000)),
